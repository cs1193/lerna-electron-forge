...
exports.isLernaMonorepo = exports.getElectronForgePackages = exports.getLernaDependentsForApp = void 0;
const path_1 = __importDefault(require("path"));
const fs = __importStar(require("fs"));
const project_1 = require("@lerna/project");
const package_graph_1 = require("@lerna/package-graph");
const _ = __importStar(require("lodash"));
const getLernaDependentsForApp = (appName) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const packages = yield project_1.getPackages();
            const graph = new package_graph_1.PackageGraph(packages, 'allDependencies', true);
            const dependents = graph.get(appName).localDependencies;
            console.log(dependents);
            const filteredDependents = _.filter(packages, (pkg) => {
                console.log(pkg);
                _.forEach(dependents, (dep, index) => {
...
exports.getLernaDependentsForApp = getLernaDependentsForApp;
