...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const spinner = ora_1.default('Building Package')
                .start();
